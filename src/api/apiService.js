...
const API_ENDPOINTS = {
  ...
  stores: {
    ...
    getUserFavorites: userId => `${API_BASE_URL}/api/stores/favorites/${userId}`,
...
export const authAPI = {
  ...
  forgotPassword: data => apiService.post(API_ENDPOINTS.auth.forgotPassword, data),
  verifyOTP: data => apiService.post(API_ENDPOINTS.auth.verifyOTP, data),
  resetPassword: data => apiService.post(API_ENDPOINTS.auth.resetPassword, data),
};
...
export const userAPI = {
  ...
  updateProfile: data => apiService.put(API_ENDPOINTS.users.updateProfile, data),
  changePassword: data => apiService.post(API_ENDPOINTS.users.changePassword, data),
  deleteAccount: async () => {
    try {
...
export const scanAPI = {
  ...
  deleteScan: scanId => apiService.delete(API_ENDPOINTS.users.deleteScan(scanId)),
};
...
export const storesAPI = {
  ...
  view: storeId => apiService.post(API_ENDPOINTS.stores.view, { store_id: storeId }),
  like: storeId => apiService.post(API_ENDPOINTS.stores.like, { store_id: storeId }),
  follow: storeId => apiService.post(API_ENDPOINTS.stores.follow, { store_id: storeId }),
  comment: (storeId, comment) =>
    apiService.post(API_ENDPOINTS.stores.comment, { store_id: storeId, comment: comment }),
  getDetails: id => apiService.get(API_ENDPOINTS.stores.getDetails(id)),
  favorite: storeId => apiService.post(API_ENDPOINTS.stores.favorite, { store_id: storeId }),
  getFavorites: () => apiService.get(API_ENDPOINTS.stores.getFavorites),
  getUserFavorites: userId => apiService.get(API_ENDPOINTS.stores.getUserFavorites(userId)),
  getNearby: (latitude, longitude, radius = 10) =>
    apiService.get(API_ENDPOINTS.stores.getNearby, { latitude, longitude, radius }),
};
...
export const promotionsAPI = {
  ...
  update: (id, data) => apiService.put(API_ENDPOINTS.promotions.update(id), data),
...
export const subscriptionsAPI = {
  ...
  updateTiers: data => apiService.put(API_ENDPOINTS.subscriptions.updateTiers, data),
...
export const statsAPI = {
  ...
  getRecentActivity: params => apiService.get(API_ENDPOINTS.stats.recentActivity, params),
  getRecentFeedbacks: params => apiService.get(API_ENDPOINTS.stats.recentFeedbacks, params),
